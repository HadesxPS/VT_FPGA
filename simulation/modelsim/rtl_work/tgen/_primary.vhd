...
entity tgen is
    generic(
        ...
        V_ACT           : vl_logic_vector(0 to 11) := (Hi1, Hi0, Hi0, Hi1, Hi1, Hi1, Hi0, Hi1, Hi1, Hi0, Hi0, Hi0);
        V_PCH           : vl_logic_vector(0 to 11) := (Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi1, Hi0, Hi0, Hi0);
        H_ABGN          : vl_notype;
        H_AEND          : vl_notype;
        H_TOTAL         : vl_notype;
        ...
        STV2_TOTAL_SHIFT: vl_logic_vector(0 to 11) := (Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi1, Hi1, Hi0);
        ...
        CKH_WIDTH       : vl_logic_vector(0 to 11) := (Hi0, Hi0, Hi0, Hi1, Hi0, Hi0, Hi0, Hi0, Hi1, Hi0, Hi0, Hi1);
        CKH_HALF_WIDTH  : vl_logic_vector(0 to 11) := (Hi0, Hi0, Hi0, Hi0, Hi1, Hi0, Hi0, Hi0, Hi0, Hi0, Hi0, Hi0);
        ...
        SRC_PCH_SHIFT   : vl_logic_vector(0 to 7) := (Hi0, Hi1, Hi0, Hi1, Hi0, Hi0, Hi0, Hi0);
    ...
    port(
        ...
        ckv4_L          : out    vl_logic;
        ckv4_R          : out    vl_logic;
        ckh1_out        : out    vl_logic;
        ckh2_out        : out    vl_logic;
        ckh3_out        : out    vl_logic;
        ckh4_out        : out    vl_logic;
        ckh5_out        : out    vl_logic;
        ckh6_out        : out    vl_logic;
    ...
    attribute mti_svvh_generic_type of CKH_HALF_WIDTH : constant is 1;
    ...
    attribute mti_svvh_generic_type of RGBRGB : constant is 1;
end tgen;
